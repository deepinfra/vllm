...
class LoRAParserAction(argparse.Action):
    ...
    def __call__(
        ...
        current_lora_list: list[LoRAModulePath] = getattr(namespace, self.dest, []) or []
        ...
        for item in values:
            ...
            if '=' in item and ',' not in item:  # Old format: name=path
                ...
                current_lora_list.append(LoRAModulePath(name, path))
            else:  # Assume JSON format
                try:
                    lora_dict = json.loads(item)
                    lora = LoRAModulePath(**lora_dict)
                    current_lora_list.append(lora)
        ...
        setattr(namespace, self.dest, current_lora_list)
