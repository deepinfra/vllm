...
from ..layers.quantization.utils.fp8_utils import input_to_float8
from ..._custom_ops import bmm_fp8
...
class DeepseekV3MLAAttention(nn.Module):
    ...
    def forward_prefill(
        ...
        attn_output = self.attn_mha(q, k, v, kv_cache, attn_metadata)
    ...
    def forward_decode(
        ...
        attn_output = self.attn_mqa(q_input, k_input, v_input, kv_cache, attn_metadata,)
